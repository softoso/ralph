                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('user.check') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="email" id="email" class="form-control-user form-control" autofocus placeholder="Mobile Number or Email" value="{{old('email')}}">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input name="is_remember" type="checkbox" class="custom-control-input" id="customCheck">
