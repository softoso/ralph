...
<head>
    ...
    <title>Softoso - Forget Password</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Please change your password to continue.</p>
                                    </div>
                                    <form class="user" method="POST" action="{{route('user.change_password')}}">
                                        <div class="form-group">
                                            @csrf
                                            <input class="d-none" type="hidden" name="email"
                                                value="{{ $email }}" class="form-control form-control-user">
                                            <br><input class="d-none" type="hidden" name="token"
                                                value="{{ $token }}" class="form-control form-control-user">
                                        </div>
