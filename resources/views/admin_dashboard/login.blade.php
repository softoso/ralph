...
<head>
    ...
    <title>Softoso - Admin Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('admin.check') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="email" id="email"
                                                class="form-control-user form-control" autofocus
                                                placeholder="Mobile Number or Email" value="{{ old('email') }}">
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input name="is_remember" type="checkbox" class="custom-control-input"
                                                    id="customCheck">
                                    ...
                                    <div class="form-group my-3 text-center">
                                        <a href="{{route('user.login')}}" class="btn btn-user btn-block btn-danger">Go to User Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
