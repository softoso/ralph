                    ...
                    <table class="table bg-light my-5">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th><a href="{{route('admin.logout')}}" onclick="event.preventDefault();document.getElementById('logout_form').submit();" class="btn btn-danger btn-sm" >Logout</a></th>
                                <td>
                                    <form class="d-none" action="{{route('admin.logout')}}" method="POST" id="logout_form">
                                    @csrf
                                    </form>
                                </td>
                            </tr>
